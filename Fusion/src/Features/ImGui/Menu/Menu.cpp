		...
		if (BeginTable("HvHTable", 2))
		{
			...
			if (Section("Fakelag"))
			{
				...
				bTransparent = FGet(Vars::CL_Move::Fakelag::Fakelag) != 1;
					FSlider("Plain ticks", Vars::CL_Move::Fakelag::PlainTicks, 1, 24, 1, "%d", FSlider_Clamp | FSlider_Left);
				bTransparent = FGet(Vars::CL_Move::Fakelag::Fakelag) != 2;
					FSlider("Random ticks", Vars::CL_Move::Fakelag::RandomTicks, 1, 24, 1, "%d - %d", FSlider_Clamp | FSlider_Right);
				bTransparent = false;
